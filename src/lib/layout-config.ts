...
export type LineCtaPositions = {
  ...
  navigationMobileHeader: string;
  navigationMobileMenu: string;
  stickyDesktop: string;
  stickyMobile: string;
};

const DEFAULT_POSITIONS: LineCtaPositions = {
  navigationDesktop: 'navigation_desktop',
  navigationMobileHeader: 'navigation_mobile_header',
  navigationMobileMenu: 'navigation_mobile_menu',
...
const AD_LANDING_POSITIONS: Record<string, LineCtaPositions> = {
  '/lp/google-ads/electric-awning': {
    navigationDesktop: 'electric_awning_ads_header',
    navigationMobileHeader: 'electric_awning_ads_header',
    navigationMobileMenu: 'electric_awning_ads_header',
