...
export default function StaticPortfolioFilters({ projects, activeCategory = 'ทั้งหมด' }: StaticPortfolioFiltersProps) {
  ...
  return (
    <div className="space-y-6">
          ...
          return (
            <Link
              ...
              className={`
                ...
                transition-all duration-300 transform hover:scale-105 opacity-0 animate-fade-in
                ${isActive 
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto">
        {Object.entries(groupedProjects).slice(0, 4).map(([category, categoryProjects], index) => (
          <div 
            key={category} 
            className="text-center p-3 bg-white rounded-lg border border-gray-100 opacity-0 animate-fade-in"
            style={{
